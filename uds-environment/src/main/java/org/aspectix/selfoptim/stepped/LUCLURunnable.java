...
public class LUCLURunnable implements SteppedRunnable {
    private final RequestType type = RequestType.LUCLU;
    ...
    public LUCLURunnable(UdsLock lock) {
        this(lock, -1, 0);
    }

    public LUCLURunnable(UdsLock lock, int fromClientId, long calcTimeNs) {
        this.lock = lock;
