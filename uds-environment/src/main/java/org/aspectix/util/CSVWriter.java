...
public class CSVWriter {
     ...
     * @param values the values to be written in the line, as an array of doubles
     */
    ...
    /**
     * Write a set of values as a single CSV line, separated by the default separator
     * @param values the values to be written in the line, as a list of strings
     */
